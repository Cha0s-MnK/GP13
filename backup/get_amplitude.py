...
def get_file_amplitude(file):
    ...
    for du in du_list:
        ...
        amplitude_result_file = os.path.join(amplitude_result_dir, f'amplitude_DU{du}_RUN{num_run}_{datetime_flat}.npz')
        np.savez(amplitude_result_file, 
        ...
        print(f'Saved: {amplitude_result_file}')
...
def main():
    ...
    file_list = sorted(glob(os.path.join(data_dir, '*20231116140503*.root')))
